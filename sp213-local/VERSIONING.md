...
> **Dernière version : `1.7.511`** — 19 septembre 2026
...
| Champ | Valeur |
|---|---|
| Version app (affichée) | `1.7.511` |
| Cache Service Worker (app **et** racine) | `superprint-shell-v1.7.511-fond-anime-neuf-effets` |
| Query JS (`main.js`) **et** CSS (`main.css`) | `?v=20260920-v511-fond-anime-neuf-effets` |
| Badge preview (`spVersionBadge`) | `v1.7.511` — 5 marqueurs : commentaire, `title` (`JS v456`), `data-sp-js="v456"`, `data-sp-sw`, texte |
| Splash screen | `1.7.511` |
| Onboarding | `LAYOUT EDITOR — V 1.7.511` + `V 1.7.511 \| 09 2026` |
| JSON-LD `softwareVersion` (lanceur `index.html` + `landing.html` + `app/index.html` + `app/landing.html`) | `1.7.511` |
| Documentation (racine **et** `app/`) | `v1.7.511` (pastille + pieds de page datés + 214 numéros de ligne) |
| `api.html` (pastille `.version`) | `v1.7.511` |
| `version.txt` | `1.7.511` |
| `llms.txt` / `llms-full.txt` (racine **et** `app/`) | `1.7.511 (September 2026)` |
| `package.json` + `package-lock.json` (sp213-local) | `1.7.511` |
...
- ⚠️ **PLUS de `sp213-local/studio.html`** (retiré en 1.7.511) : il faisait doublon avec le
