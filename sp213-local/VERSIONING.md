...
> **Dernière version : `1.7.407`** — 14 septembre 2026
...
| Champ | Valeur |
|---|---|
| Version app (affichée) | `1.7.407` |
| Cache Service Worker | `superprint-shell-v1.7.407-no-whatsapp` |
| Query JS (`main.js`) | `?v=20260913-v407-pipette-safari` |
| Badge preview (`spVersionBadge`) | `v1.7.407` |
| Splash screen | `v1.7.407` |
| Préférences (panneau SUPERPRINT) | `v1.7.407` |
| Préférences (bas de page) | `SuperPrint v1.7.407 — 14 septembre 2026` |
| Onboarding (`V 1.7.407`) | `1.7.407` |
| Landing (`softwareVersion` + footer) | `1.7.407` |
| Documentation | `v1.7.407` |
| `version.txt` | `1.7.407` |
| `llms.txt` / `llms-full.txt` | `1.7.407 (September 2026)` |
| `package.json` (sp213-local) | `1.7.407` |
