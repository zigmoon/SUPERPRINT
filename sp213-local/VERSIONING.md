...
> **Dernière version : `1.7.481`** — 18 septembre 2026
...
| Champ | Valeur |
|---|---|
| Version app (affichée) | `1.7.481` |
| Cache Service Worker (app **et** racine) | `superprint-shell-v1.7.481-taquets-police-variable` |
| Query JS (`main.js`) **et** CSS (`main.css`) | `?v=20260918-v481-taquets-police-variable` |
| Badge preview (`spVersionBadge`) | `v1.7.481` — 5 marqueurs : commentaire, `title` (`JS v456`), `data-sp-js="v456"`, `data-sp-sw`, texte |
| Splash screen | `1.7.481` |
| Onboarding | `LAYOUT EDITOR — V 1.7.481` + `V 1.7.481 \| 09 2026` |
| JSON-LD `softwareVersion` (lanceur `index.html` + `landing.html` + `app/index.html` + `app/landing.html`) | `1.7.481` |
| Documentation (racine **et** `app/`) | `v1.7.481` (pastille + pieds de page datés + 214 numéros de ligne) |
| `api.html` (pastille `.version`) | `v1.7.481` |
| `version.txt` | `1.7.481` |
| `llms.txt` / `llms-full.txt` (racine **et** `app/`) | `1.7.481 (September 2026)` |
| `package.json` + `package-lock.json` (sp213-local) | `1.7.481` |
...
> 18 septembre 2026). Le bump 1.7.481 les a remis à niveau — **vérifier leur présence dans
...
- ⚠️ **PLUS de `sp213-local/studio.html`** (retiré en 1.7.481) : il faisait doublon avec le
