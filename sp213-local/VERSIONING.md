...
> **Dernière version : `1.7.396`** — 12 septembre 2026
...
| Champ | Valeur |
|---|---|
| Version app (affichée) | `1.7.396` |
| Cache Service Worker | `superprint-shell-v1.7.396-no-whatsapp` |
| Query JS (`main.js`) | `?v=20260913-v396-import-doc` |
| Badge preview (`spVersionBadge`) | `v1.7.396` |
| Splash screen | `v1.7.396` |
| Préférences (panneau SUPERPRINT) | `v1.7.396` |
| Préférences (bas de page) | `SuperPrint v1.7.396 — 12 septembre 2026` |
| Onboarding (`V 1.7.396`) | `1.7.396` |
| Landing (`softwareVersion` + footer) | `1.7.396` |
| Documentation | `v1.7.396` |
| `version.txt` | `1.7.396` |
| `llms.txt` / `llms-full.txt` | `1.7.396 (September 2026)` |
| `package.json` (sp213-local) | `1.7.396` |
