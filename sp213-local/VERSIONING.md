...
> **Dernière version : `1.7.371`** — 12 septembre 2026
...
| Champ | Valeur |
|---|---|
| Version app (affichée) | `1.7.371` |
| Cache Service Worker | `superprint-shell-v1.7.371-no-whatsapp` |
| Query JS (`main.js`) | `?v=20260913-v371-typo-clip` |
| Badge preview (`spVersionBadge`) | `v1.7.371` |
| Splash screen | `v1.7.371` |
| Préférences (panneau SUPERPRINT) | `v1.7.371` |
| Préférences (bas de page) | `SuperPrint v1.7.371 — 12 septembre 2026` |
| Onboarding (`V 1.7.371`) | `1.7.371` |
| Landing (`softwareVersion` + footer) | `1.7.371` |
| Documentation | `v1.7.371` |
| `version.txt` | `1.7.371` |
| `llms.txt` / `llms-full.txt` | `1.7.371 (September 2026)` |
| `package.json` (sp213-local) | `1.7.371` |
