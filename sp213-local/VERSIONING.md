...
> **Dernière version : `1.7.370`** — 12 septembre 2026
...
| Champ | Valeur |
|---|---|
| Version app (affichée) | `1.7.370` |
| Cache Service Worker | `superprint-shell-v1.7.370-no-whatsapp` |
| Query JS (`main.js`) | `?v=20260912-v370-release` |
| Badge preview (`spVersionBadge`) | `v1.7.370` |
| Splash screen | `v1.7.370` |
| Préférences (panneau SUPERPRINT) | `v1.7.370` |
| Préférences (bas de page) | `SuperPrint v1.7.370 — 12 septembre 2026` |
| Onboarding (`V 1.7.370`) | `1.7.370` |
| Landing (`softwareVersion` + footer) | `1.7.370` |
| Documentation | `v1.7.370` |
| `version.txt` | `1.7.370` |
| `llms.txt` / `llms-full.txt` | `1.7.370 (September 2026)` |
| `package.json` (sp213-local) | `1.7.370` |
