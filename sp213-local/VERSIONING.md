...
> **Dernière version : `1.7.539`** — 19 septembre 2026
...
| Champ | Valeur |
|---|---|
| Version app (affichée) | `1.7.539` |
| Cache Service Worker (app **et** racine) | `superprint-shell-v1.7.539-regle-taquets` |
| Query JS (`main.js`) **et** CSS (`main.css`) | `?v=20261009-v539-regle-taquets` |
| Badge preview (`spVersionBadge`) | `v1.7.539` — 5 marqueurs : commentaire, `title` (`JS v456`), `data-sp-js="v456"`, `data-sp-sw`, texte |
| Splash screen | `1.7.539` |
| Onboarding | `LAYOUT EDITOR — V 1.7.539` + `V 1.7.539 \| 09 2026` |
| JSON-LD `softwareVersion` (lanceur `index.html` + `landing.html` + `app/index.html` + `app/landing.html`) | `1.7.539` |
| Documentation (racine **et** `app/`) | `v1.7.539` (pastille + pieds de page datés + 214 numéros de ligne) |
| `api.html` (pastille `.version`) | `v1.7.539` |
| `version.txt` | `1.7.539` |
| `llms.txt` / `llms-full.txt` (racine **et** `app/`) | `1.7.539 (September 2026)` |
| `package.json` + `package-lock.json` (sp213-local) | `1.7.539` |
...
- ⚠️ **PLUS de `sp213-local/studio.html`** (retiré en 1.7.539) : il faisait doublon avec le
