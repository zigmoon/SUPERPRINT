...
> **Dernière version : `1.7.368`** — 12 septembre 2026
...
| Champ | Valeur |
|---|---|
| Version app (affichée) | `1.7.368` |
| Cache Service Worker | `superprint-shell-v1.7.368c-no-whatsapp` |
| Query JS (`main.js`) | `?v=20260912-v368-launcher-supertypo` |
| Badge preview (`spVersionBadge`) | `v1.7.368` |
| Splash screen | `v1.7.368` |
| Préférences (panneau SUPERPRINT) | `v1.7.368` |
| Préférences (bas de page) | `SuperPrint v1.7.368 — 12 septembre 2026` |
| Onboarding (`V 1.7.368`) | `1.7.368` |
| Landing (`softwareVersion` + footer) | `1.7.368` |
| Documentation | `v1.7.368` |
| `version.txt` | `1.7.368` |
| `llms.txt` / `llms-full.txt` | `1.7.368 (September 2026)` |
| `package.json` (sp213-local) | `1.7.368` |
