...
> **Dernière version : `1.7.411`** — 14 septembre 2026
...
| Champ | Valeur |
|---|---|
| Version app (affichée) | `1.7.411` |
| Cache Service Worker | `superprint-shell-v1.7.411-no-whatsapp` |
| Query JS (`main.js`) | `?v=20260913-v411-grands-formats` |
| Badge preview (`spVersionBadge`) | `v1.7.411` |
| Splash screen | `v1.7.411` |
| Préférences (panneau SUPERPRINT) | `v1.7.411` |
| Préférences (bas de page) | `SuperPrint v1.7.411 — 14 septembre 2026` |
| Onboarding (`V 1.7.411`) | `1.7.411` |
| Landing (`softwareVersion` + footer) | `1.7.411` |
| Documentation | `v1.7.411` |
| `version.txt` | `1.7.411` |
| `llms.txt` / `llms-full.txt` | `1.7.411 (September 2026)` |
| `package.json` (sp213-local) | `1.7.411` |
