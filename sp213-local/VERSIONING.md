...
> **Dernière version : `1.7.369`** — 12 septembre 2026
...
| Champ | Valeur |
|---|---|
| Version app (affichée) | `1.7.369` |
| Cache Service Worker | `superprint-shell-v1.7.369-no-whatsapp` |
| Query JS (`main.js`) | `?v=20260912-v369-margins` |
| Badge preview (`spVersionBadge`) | `v1.7.369` |
| Splash screen | `v1.7.369` |
| Préférences (panneau SUPERPRINT) | `v1.7.369` |
| Préférences (bas de page) | `SuperPrint v1.7.369 — 12 septembre 2026` |
| Onboarding (`V 1.7.369`) | `1.7.369` |
| Landing (`softwareVersion` + footer) | `1.7.369` |
| Documentation | `v1.7.369` |
| `version.txt` | `1.7.369` |
| `llms.txt` / `llms-full.txt` | `1.7.369 (September 2026)` |
| `package.json` (sp213-local) | `1.7.369` |
