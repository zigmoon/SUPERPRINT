...
> **Dernière version : `1.7.492`** — 19 septembre 2026
...
| Champ | Valeur |
|---|---|
| Version app (affichée) | `1.7.492` |
| Cache Service Worker (app **et** racine) | `superprint-shell-v1.7.492-huit-surtitres` |
| Query JS (`main.js`) **et** CSS (`main.css`) | `?v=20260919-v492-huit-surtitres` |
| Badge preview (`spVersionBadge`) | `v1.7.492` — 5 marqueurs : commentaire, `title` (`JS v456`), `data-sp-js="v456"`, `data-sp-sw`, texte |
| Splash screen | `1.7.492` |
| Onboarding | `LAYOUT EDITOR — V 1.7.492` + `V 1.7.492 \| 09 2026` |
| JSON-LD `softwareVersion` (lanceur `index.html` + `landing.html` + `app/index.html` + `app/landing.html`) | `1.7.492` |
| Documentation (racine **et** `app/`) | `v1.7.492` (pastille + pieds de page datés + 214 numéros de ligne) |
| `api.html` (pastille `.version`) | `v1.7.492` |
| `version.txt` | `1.7.492` |
| `llms.txt` / `llms-full.txt` (racine **et** `app/`) | `1.7.492 (September 2026)` |
| `package.json` + `package-lock.json` (sp213-local) | `1.7.492` |
...
- ⚠️ **PLUS de `sp213-local/studio.html`** (retiré en 1.7.492) : il faisait doublon avec le
