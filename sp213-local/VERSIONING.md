...
> **Dernière version : `1.7.413`** — 14 septembre 2026
...
| Champ | Valeur |
|---|---|
| Version app (affichée) | `1.7.413` |
| Cache Service Worker | `superprint-shell-v1.7.413-no-whatsapp` |
| Query JS (`main.js`) | `?v=20260913-v413-collage-masse` |
| Badge preview (`spVersionBadge`) | `v1.7.413` |
| Splash screen | `v1.7.413` |
| Préférences (panneau SUPERPRINT) | `v1.7.413` |
| Préférences (bas de page) | `SuperPrint v1.7.413 — 14 septembre 2026` |
| Onboarding (`V 1.7.413`) | `1.7.413` |
| Landing (`softwareVersion` + footer) | `1.7.413` |
| Documentation | `v1.7.413` |
| `version.txt` | `1.7.413` |
| `llms.txt` / `llms-full.txt` | `1.7.413 (September 2026)` |
| `package.json` (sp213-local) | `1.7.413` |
