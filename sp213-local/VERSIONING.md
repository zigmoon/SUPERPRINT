...
> **Dernière version : `1.7.345`** — 9 septembre 2026
...
| Champ | Valeur |
|---|---|
| Version app (affichée) | `1.7.345` |
| Cache Service Worker | `superprint-shell-v1.7.345-no-whatsapp` |
| Query JS (`main.js`) | `?v=20260909-v345-doc-rework` |
| Badge preview (`spVersionBadge`) | `v1.7.345` |
| Splash screen | `v1.7.345` |
| Préférences (panneau SUPERPRINT) | `v1.7.345` |
| Préférences (bas de page) | `SuperPrint v1.7.345 — 9 septembre 2026` |
| Onboarding (`V 1.7.345`) | `1.7.345` |
| Landing (`softwareVersion` + footer) | `1.7.345` |
| Documentation | `v1.7.345` |
| `version.txt` | `1.7.345` |
| `llms.txt` / `llms-full.txt` | `1.7.345 (September 2026)` |
| `package.json` (sp213-local) | `1.7.345` |
...
Ex. si le badge affichait `1.7.271`, bump vers `1.7.345` minimum.
...
1. Choisir le nouveau numéro (ex. `1.7.345`) — **toujours > au cache SW actuel**.
2. Mettre à jour TOUS les fichiers de la section 2 (web + copie locale).
3. Vérifier : `grep -r "1.7.345" superprint/` → plus aucune occurrence (sauf changelog main.js).
