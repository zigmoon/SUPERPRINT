...
> **Dernière version : `1.7.383`** — 12 septembre 2026
...
| Champ | Valeur |
|---|---|
| Version app (affichée) | `1.7.383` |
| Cache Service Worker | `superprint-shell-v1.7.383-no-whatsapp` |
| Query JS (`main.js`) | `?v=20260913-v383-studio-spread` |
| Badge preview (`spVersionBadge`) | `v1.7.383` |
| Splash screen | `v1.7.383` |
| Préférences (panneau SUPERPRINT) | `v1.7.383` |
| Préférences (bas de page) | `SuperPrint v1.7.383 — 12 septembre 2026` |
| Onboarding (`V 1.7.383`) | `1.7.383` |
| Landing (`softwareVersion` + footer) | `1.7.383` |
| Documentation | `v1.7.383` |
| `version.txt` | `1.7.383` |
| `llms.txt` / `llms-full.txt` | `1.7.383 (September 2026)` |
| `package.json` (sp213-local) | `1.7.383` |
