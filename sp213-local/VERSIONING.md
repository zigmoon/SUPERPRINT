...
> **Dernière version : `1.7.463`** — 17 septembre 2026
...
| Champ | Valeur |
|---|---|
| Version app (affichée) | `1.7.463` |
| Cache Service Worker (app **et** racine) | `superprint-shell-v1.7.463-landing-cartes` |
| Query JS (`main.js`) **et** CSS (`main.css`) | `?v=20260918-v463-landing-cartes` |
| Badge preview (`spVersionBadge`) | `v1.7.463` — 5 marqueurs : commentaire, `title` (`JS v456`), `data-sp-js="v456"`, `data-sp-sw`, texte |
| Splash screen | `1.7.463` |
| Onboarding | `LAYOUT EDITOR — V 1.7.463` + `V 1.7.463 \| 09 2026` |
| JSON-LD `softwareVersion` (lanceur `index.html` + `landing.html` + `app/index.html` + `app/landing.html`) | `1.7.463` |
| Documentation (racine **et** `app/`) | `v1.7.463` (pastille + pieds de page datés + 214 numéros de ligne) |
| `api.html` (pastille `.version`) | `v1.7.463` |
| `version.txt` | `1.7.463` |
| `llms.txt` / `llms-full.txt` (racine **et** `app/`) | `1.7.463 (September 2026)` |
| `package.json` + `package-lock.json` (sp213-local) | `1.7.463` |
...
> 17 septembre 2026). Le bump 1.7.463 les a remis à niveau — **vérifier leur présence dans
