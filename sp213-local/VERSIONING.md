...
> **Dernière version : `1.7.388`** — 12 septembre 2026
...
| Champ | Valeur |
|---|---|
| Version app (affichée) | `1.7.388` |
| Cache Service Worker | `superprint-shell-v1.7.388-no-whatsapp` |
| Query JS (`main.js`) | `?v=20260913-v388-word-images` |
| Badge preview (`spVersionBadge`) | `v1.7.388` |
| Splash screen | `v1.7.388` |
| Préférences (panneau SUPERPRINT) | `v1.7.388` |
| Préférences (bas de page) | `SuperPrint v1.7.388 — 12 septembre 2026` |
| Onboarding (`V 1.7.388`) | `1.7.388` |
| Landing (`softwareVersion` + footer) | `1.7.388` |
| Documentation | `v1.7.388` |
| `version.txt` | `1.7.388` |
| `llms.txt` / `llms-full.txt` | `1.7.388 (September 2026)` |
| `package.json` (sp213-local) | `1.7.388` |
