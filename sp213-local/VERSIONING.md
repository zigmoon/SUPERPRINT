...
> **Dernière version : `1.7.403`** — 12 septembre 2026
...
| Champ | Valeur |
|---|---|
| Version app (affichée) | `1.7.403` |
| Cache Service Worker | `superprint-shell-v1.7.403-no-whatsapp` |
| Query JS (`main.js`) | `?v=20260913-v400-retouche-page` |
| Badge preview (`spVersionBadge`) | `v1.7.403` |
| Splash screen | `v1.7.403` |
| Préférences (panneau SUPERPRINT) | `v1.7.403` |
| Préférences (bas de page) | `SuperPrint v1.7.403 — 12 septembre 2026` |
| Onboarding (`V 1.7.403`) | `1.7.403` |
| Landing (`softwareVersion` + footer) | `1.7.403` |
| Documentation | `v1.7.403` |
| `version.txt` | `1.7.403` |
| `llms.txt` / `llms-full.txt` | `1.7.403 (September 2026)` |
| `package.json` (sp213-local) | `1.7.403` |
