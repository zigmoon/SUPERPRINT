...
> **Dernière version : `1.7.343`** — 8 septembre 2026
...
| Champ | Valeur |
|---|---|
| Version app (affichée) | `1.7.343` |
| Cache Service Worker | `superprint-shell-v1.7.343-no-whatsapp` |
| Query JS (`main.js`) | `?v=20260908-v343-export-parity` |
| Badge preview (`spVersionBadge`) | `v1.7.343` |
| Splash screen | `v1.7.343` |
| Préférences (panneau SUPERPRINT) | `v1.7.343` |
| Préférences (bas de page) | `SuperPrint v1.7.343 — 8 septembre 2026` |
| Onboarding (`V 1.7.343`) | `1.7.343` |
| Landing (`softwareVersion` + footer) | `1.7.343` |
| Documentation | `v1.7.343` |
| `version.txt` | `1.7.343` |
| `llms.txt` / `llms-full.txt` | `1.7.343 (September 2026)` |
| `package.json` (sp213-local) | `1.7.343` |
...
Ex. si le badge affichait `1.7.271`, bump vers `1.7.343` minimum.
...
1. Choisir le nouveau numéro (ex. `1.7.343`) — **toujours > au cache SW actuel**.
2. Mettre à jour TOUS les fichiers de la section 2 (web + copie locale).
3. Vérifier : `grep -r "1.7.343" superprint/` → plus aucune occurrence (sauf changelog main.js).
