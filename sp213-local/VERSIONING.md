...
> **Dernière version : `1.7.496`** — 19 septembre 2026
...
| Champ | Valeur |
|---|---|
| Version app (affichée) | `1.7.496` |
| Cache Service Worker (app **et** racine) | `superprint-shell-v1.7.496-marges-et-menu-aide` |
| Query JS (`main.js`) **et** CSS (`main.css`) | `?v=20260920-v496-marges-et-menu-aide` |
| Badge preview (`spVersionBadge`) | `v1.7.496` — 5 marqueurs : commentaire, `title` (`JS v456`), `data-sp-js="v456"`, `data-sp-sw`, texte |
| Splash screen | `1.7.496` |
| Onboarding | `LAYOUT EDITOR — V 1.7.496` + `V 1.7.496 \| 09 2026` |
| JSON-LD `softwareVersion` (lanceur `index.html` + `landing.html` + `app/index.html` + `app/landing.html`) | `1.7.496` |
| Documentation (racine **et** `app/`) | `v1.7.496` (pastille + pieds de page datés + 214 numéros de ligne) |
| `api.html` (pastille `.version`) | `v1.7.496` |
| `version.txt` | `1.7.496` |
| `llms.txt` / `llms-full.txt` (racine **et** `app/`) | `1.7.496 (September 2026)` |
| `package.json` + `package-lock.json` (sp213-local) | `1.7.496` |
...
- ⚠️ **PLUS de `sp213-local/studio.html`** (retiré en 1.7.496) : il faisait doublon avec le
