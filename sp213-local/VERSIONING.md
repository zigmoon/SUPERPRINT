...
> **Dernière version : `1.7.397`** — 12 septembre 2026
...
| Champ | Valeur |
|---|---|
| Version app (affichée) | `1.7.397` |
| Cache Service Worker | `superprint-shell-v1.7.397-no-whatsapp` |
| Query JS (`main.js`) | `?v=20260913-v397-studio-ia` |
| Badge preview (`spVersionBadge`) | `v1.7.397` |
| Splash screen | `v1.7.397` |
| Préférences (panneau SUPERPRINT) | `v1.7.397` |
| Préférences (bas de page) | `SuperPrint v1.7.397 — 12 septembre 2026` |
| Onboarding (`V 1.7.397`) | `1.7.397` |
| Landing (`softwareVersion` + footer) | `1.7.397` |
| Documentation | `v1.7.397` |
| `version.txt` | `1.7.397` |
| `llms.txt` / `llms-full.txt` | `1.7.397 (September 2026)` |
| `package.json` (sp213-local) | `1.7.397` |
