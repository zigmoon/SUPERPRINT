...
> **Dernière version : `1.7.377`** — 12 septembre 2026
...
| Champ | Valeur |
|---|---|
| Version app (affichée) | `1.7.377` |
| Cache Service Worker | `superprint-shell-v1.7.377-no-whatsapp` |
| Query JS (`main.js`) | `?v=20260913-v377-shape-menu` |
| Badge preview (`spVersionBadge`) | `v1.7.377` |
| Splash screen | `v1.7.377` |
| Préférences (panneau SUPERPRINT) | `v1.7.377` |
| Préférences (bas de page) | `SuperPrint v1.7.377 — 12 septembre 2026` |
| Onboarding (`V 1.7.377`) | `1.7.377` |
| Landing (`softwareVersion` + footer) | `1.7.377` |
| Documentation | `v1.7.377` |
| `version.txt` | `1.7.377` |
| `llms.txt` / `llms-full.txt` | `1.7.377 (September 2026)` |
| `package.json` (sp213-local) | `1.7.377` |
