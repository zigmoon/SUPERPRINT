...
> **Dernière version : `1.7.529`** — 19 septembre 2026
...
| Champ | Valeur |
|---|---|
| Version app (affichée) | `1.7.529` |
| Cache Service Worker (app **et** racine) | `superprint-shell-v1.7.529-croix-nuanciers` |
| Query JS (`main.js`) **et** CSS (`main.css`) | `?v=20260929-v529-croix-nuanciers` |
| Badge preview (`spVersionBadge`) | `v1.7.529` — 5 marqueurs : commentaire, `title` (`JS v456`), `data-sp-js="v456"`, `data-sp-sw`, texte |
| Splash screen | `1.7.529` |
| Onboarding | `LAYOUT EDITOR — V 1.7.529` + `V 1.7.529 \| 09 2026` |
| JSON-LD `softwareVersion` (lanceur `index.html` + `landing.html` + `app/index.html` + `app/landing.html`) | `1.7.529` |
| Documentation (racine **et** `app/`) | `v1.7.529` (pastille + pieds de page datés + 214 numéros de ligne) |
| `api.html` (pastille `.version`) | `v1.7.529` |
| `version.txt` | `1.7.529` |
| `llms.txt` / `llms-full.txt` (racine **et** `app/`) | `1.7.529 (September 2026)` |
| `package.json` + `package-lock.json` (sp213-local) | `1.7.529` |
...
- ⚠️ **PLUS de `sp213-local/studio.html`** (retiré en 1.7.529) : il faisait doublon avec le
