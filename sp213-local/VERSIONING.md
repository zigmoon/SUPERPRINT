...
> **Dernière version : `1.7.354`** — 12 septembre 2026
...
| Champ | Valeur |
|---|---|
| Version app (affichée) | `1.7.354` |
| Cache Service Worker | `superprint-shell-v1.7.354c-no-whatsapp` |
| Query JS (`main.js`) | `?v=20260912-v354-launcher-supertypo` |
| Badge preview (`spVersionBadge`) | `v1.7.354` |
| Splash screen | `v1.7.354` |
| Préférences (panneau SUPERPRINT) | `v1.7.354` |
| Préférences (bas de page) | `SuperPrint v1.7.354 — 12 septembre 2026` |
| Onboarding (`V 1.7.354`) | `1.7.354` |
| Landing (`softwareVersion` + footer) | `1.7.354` |
| Documentation | `v1.7.354` |
| `version.txt` | `1.7.354` |
| `llms.txt` / `llms-full.txt` | `1.7.354 (September 2026)` |
| `package.json` (sp213-local) | `1.7.354` |
...
Ex. si le badge affichait `1.7.271`, bump vers `1.7.354` minimum.
...
1. Choisir le nouveau numéro (ex. `1.7.354`) — **toujours > au cache SW actuel**.
2. Mettre à jour TOUS les fichiers de la section 2 (web + copie locale).
3. Vérifier : `grep -r "1.7.354" superprint/` → plus aucune occurrence (sauf changelog main.js).
