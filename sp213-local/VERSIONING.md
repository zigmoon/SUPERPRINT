...
> **Dernière version : `1.7.376`** — 12 septembre 2026
...
| Champ | Valeur |
|---|---|
| Version app (affichée) | `1.7.376` |
| Cache Service Worker | `superprint-shell-v1.7.376-no-whatsapp` |
| Query JS (`main.js`) | `?v=20260913-v376-text-wrap` |
| Badge preview (`spVersionBadge`) | `v1.7.376` |
| Splash screen | `v1.7.376` |
| Préférences (panneau SUPERPRINT) | `v1.7.376` |
| Préférences (bas de page) | `SuperPrint v1.7.376 — 12 septembre 2026` |
| Onboarding (`V 1.7.376`) | `1.7.376` |
| Landing (`softwareVersion` + footer) | `1.7.376` |
| Documentation | `v1.7.376` |
| `version.txt` | `1.7.376` |
| `llms.txt` / `llms-full.txt` | `1.7.376 (September 2026)` |
| `package.json` (sp213-local) | `1.7.376` |
