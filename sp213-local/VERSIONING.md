...
> **Dernière version : `1.7.412`** — 14 septembre 2026
...
| Champ | Valeur |
|---|---|
| Version app (affichée) | `1.7.412` |
| Cache Service Worker | `superprint-shell-v1.7.412-no-whatsapp` |
| Query JS (`main.js`) | `?v=20260913-v412-pipette-couleurs` |
| Badge preview (`spVersionBadge`) | `v1.7.412` |
| Splash screen | `v1.7.412` |
| Préférences (panneau SUPERPRINT) | `v1.7.412` |
| Préférences (bas de page) | `SuperPrint v1.7.412 — 14 septembre 2026` |
| Onboarding (`V 1.7.412`) | `1.7.412` |
| Landing (`softwareVersion` + footer) | `1.7.412` |
| Documentation | `v1.7.412` |
| `version.txt` | `1.7.412` |
| `llms.txt` / `llms-full.txt` | `1.7.412 (September 2026)` |
| `package.json` (sp213-local) | `1.7.412` |
