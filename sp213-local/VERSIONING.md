...
> **Dernière version : `1.7.373`** — 12 septembre 2026
...
| Champ | Valeur |
|---|---|
| Version app (affichée) | `1.7.373` |
| Cache Service Worker | `superprint-shell-v1.7.373-no-whatsapp` |
| Query JS (`main.js`) | `?v=20260913-v373-splash-typo` |
| Badge preview (`spVersionBadge`) | `v1.7.373` |
| Splash screen | `v1.7.373` |
| Préférences (panneau SUPERPRINT) | `v1.7.373` |
| Préférences (bas de page) | `SuperPrint v1.7.373 — 12 septembre 2026` |
| Onboarding (`V 1.7.373`) | `1.7.373` |
| Landing (`softwareVersion` + footer) | `1.7.373` |
| Documentation | `v1.7.373` |
| `version.txt` | `1.7.373` |
| `llms.txt` / `llms-full.txt` | `1.7.373 (September 2026)` |
| `package.json` (sp213-local) | `1.7.373` |
