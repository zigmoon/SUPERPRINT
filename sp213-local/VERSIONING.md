...
> **Dernière version : `1.7.404`** — 12 septembre 2026
...
| Champ | Valeur |
|---|---|
| Version app (affichée) | `1.7.404` |
| Cache Service Worker | `superprint-shell-v1.7.404-no-whatsapp` |
| Query JS (`main.js`) | `?v=20260913-v400-retouche-page` |
| Badge preview (`spVersionBadge`) | `v1.7.404` |
| Splash screen | `v1.7.404` |
| Préférences (panneau SUPERPRINT) | `v1.7.404` |
| Préférences (bas de page) | `SuperPrint v1.7.404 — 12 septembre 2026` |
| Onboarding (`V 1.7.404`) | `1.7.404` |
| Landing (`softwareVersion` + footer) | `1.7.404` |
| Documentation | `v1.7.404` |
| `version.txt` | `1.7.404` |
| `llms.txt` / `llms-full.txt` | `1.7.404 (September 2026)` |
| `package.json` (sp213-local) | `1.7.404` |
