...
> **Dernière version : `1.7.332`** — 4 septembre 2026
...
| Champ | Valeur |
|---|---|
| Version app (affichée) | `1.7.332` |
| Cache Service Worker | `superprint-shell-v1.7.332-no-whatsapp` |
| Query JS (`main.js`) | `?v=20260904-v332-sp213` |
| Badge preview (`spVersionBadge`) | `v1.7.332` |
| Splash screen | `v1.7.332` |
| Préférences (panneau SUPERPRINT) | `v1.7.332` |
| Préférences (bas de page) | `SuperPrint v1.7.332 — 4 septembre 2026` |
| Onboarding (`V 1.7.332`) | `1.7.332` |
| Landing (`softwareVersion` + footer) | `1.7.332` |
| Documentation | `v1.7.332` |
| `version.txt` | `1.7.332` |
| `llms.txt` / `llms-full.txt` | `1.7.332 (September 2026)` |
| `package.json` (sp213-local) | `1.7.332` |
...
Ex. si le badge affichait `1.7.271`, bump vers `1.7.332` minimum.
...
1. Choisir le nouveau numéro (ex. `1.7.332`) — **toujours > au cache SW actuel**.
2. Mettre à jour TOUS les fichiers de la section 2 (web + copie locale).
3. Vérifier : `grep -r "1.7.332" superprint/` → plus aucune occurrence (sauf changelog main.js).
