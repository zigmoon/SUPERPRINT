...
<p align="center">
  <img alt="App" src="https://img.shields.io/badge/app-1.7.406-000000?style=flat-square">
...
```bash
git log --oneline v1.7.400..v1.7.406      # what changed between two releases
git diff v1.7.380 v1.7.406 --stat         # full diff between two
```

`release.html` holds the **complete trilingual (FR / EN / JP) release notes** — **129 entries** covering the whole family (91 for SuperPrint, spanning `1.7.92` → `1.7.406`) alongside the team's other applications. It is also published at [app.zigmoon.com/release.html](https://app.zigmoon.com/release.html). `CHANGELOG.md` is the condensed English version.
