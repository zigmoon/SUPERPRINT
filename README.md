...
<p align="center">
  <img alt="Version" src="https://img.shields.io/badge/version-1.7.388-000000?style=flat-square">
...
```bash
git log --oneline v1.7.386..v1.7.388      # what changed in one release
git diff v1.7.380 v1.7.388 --stat         # full diff between two
```
