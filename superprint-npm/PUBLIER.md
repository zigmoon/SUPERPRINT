...
C'est tout. Le package `superprint` est en ligne (version actuelle : **1.0.103**).
...
| `version.txt` | Version en ligne (`1.7.503`) — permet la détection de mise à jour. À déployer en même temps que le zip. |
